...
def make_orbit_gif(a_list, p_list, r_list, directory, name, figsize=(8,8), color_list=None, increments=100, title = False):
...
def gif_from_archive(system_name: str, directory, name, figsize=(8,8), color_list=None, increments=100, title = False):
    ...
    make_orbit_gif(a_list, p_list, r_list, directory=directory, name=name, figsize=figsize, color_list=color_list, increments=increments, title=title)
